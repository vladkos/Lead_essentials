...
//
//  Created by Vladyslav Kostenko on 18/04/2023.
//
...
final class NetworkingEndToEndTests: XCTestCase {
    ...
    private func getFeedResult(file: StaticString = #file, line: UInt = #line) -> LoadFeedReault? {
        ...
        var receivedResult: LoadFeedReault?
